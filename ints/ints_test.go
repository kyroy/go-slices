...
func TestContains(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var got bool = ints.Contains(tt.args.s, tt.args.x)
			assert.Equal(t, tt.want, got)
			got = ints.New(tt.args.s).Contains(tt.args.x)
			assert.Equal(t, tt.want, got)
		})
	}
}
...
func TestIndexOf(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var got int = ints.IndexOf(tt.args.s, tt.args.x)
			assert.Equal(t, tt.want, got)
			got = ints.New(tt.args.s).IndexOf(tt.args.x)
			assert.Equal(t, tt.want, got)
		})
	}
}
...
func TestFind(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var got1 *int = ints.Find(tt.args.s, tt.args.f)
			var got2 *int = ints.New(tt.args.s).Find(tt.args.f)
			if tt.found {
