...
func TestContains(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var got bool = uint16s.Contains(tt.args.s, tt.args.x)
			assert.Equal(t, tt.want, got)
			got = uint16s.New(tt.args.s).Contains(tt.args.x)
			assert.Equal(t, tt.want, got)
		})
	}
}
...
func TestIndexOf(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var got int = uint16s.IndexOf(tt.args.s, tt.args.x)
			assert.Equal(t, tt.want, got)
			got = uint16s.New(tt.args.s).IndexOf(tt.args.x)
			assert.Equal(t, tt.want, got)
		})
	}
}
...
func TestFind(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				s: []uint16{1, 2, 3, 4, 2},
				f: func(x uint16) bool { return x > 5 },
			},
			want: 0,
			found: false,
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var got1 *uint16 = uint16s.Find(tt.args.s, tt.args.f)
			var got2 *uint16 = uint16s.New(tt.args.s).Find(tt.args.f)
			if tt.found {
